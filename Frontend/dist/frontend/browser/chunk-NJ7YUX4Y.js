...
var AuthService = class _AuthService {
  ...
  // Register new user
  register(data) {
    return this.http.post(`${this.apiUrl}/register`, data).pipe(tap((response) => this.handleAuthResponse(response)), catchError((error) => {
  ...
  // Login user
  login(credentials) {
    return this.http.post(`${this.apiUrl}/login`, credentials).pipe(tap((response) => this.handleAuthResponse(response)), catchError((error) => {
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-NJ7YUX4Y.js.map
