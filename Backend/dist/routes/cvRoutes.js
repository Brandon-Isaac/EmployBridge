...
router.post('/generate', authMiddleware_1.authenticate, cvController_1.generateAICV);
router.get('/download/:id', authMiddleware_1.authenticate, cvController_1.downloadCV);
