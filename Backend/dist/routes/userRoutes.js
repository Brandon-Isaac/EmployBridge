...
router.put('/profile/password', authMiddleware_1.authenticate, userController_1.updateUserPassword);
router.put('/profile/role', authMiddleware_1.authenticate, (0, authMiddleware_1.authorize)(['admin']), userController_1.updateUserRole);
router.delete('/profile', authMiddleware_1.authenticate, userController_1.deleteUser);
router.post('/logout', authMiddleware_1.authenticate, userController_1.logoutUser);
// Admin routes
